...
export default function SendMoneyPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase.rpc("send_money_by_matric_number", {
  ...
  return (
    <main className="min-h-screen bg-hub-bg px-5 pt-5">
      ...
      <p className="mt-1 text-sm text-hub-textDim">Send to another Uni.hub user by their matric number.</p>
