              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {t.description && (
                      <p className="text-xs text-hub-textDim">{t.description}</p>
                    )}
                  </div>
                </div>
...
function ActionButton({
  ...
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-center gap-2 rounded-xl border border-hub-border bg-hub-card p-4"
    >
...
function EyeIcon({ show }: { show: boolean }) {
  return show ? (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path d="M2 12s4-8 10-8 10 8 10 8-4 8-10 8-10-8-10-8z" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
...
function SendIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M21 3L11 13M21 3l-7 18-4-8-8-4 19-6z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
